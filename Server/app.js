...
apiRoutes.post('/carCost', function(req, res) {
  console.log(req.body.mark + ' - ' + req.body.model);
  var url = "http://auto2.yandex.ru/api/1.0/stats/?rid=213&mark=" + req.body.mark + "&model=" + req.body.model;
